...
/**
 * Loads generic data which can be text (the default), binary data, or URL-stringifyd variables. <br /><br />
 * 
 ...
 * If the <code>format</code> vars property is "variables", the <code>content</code> will be a <code>URLVariables</code> object containing the URL-stringifyd variables<br /><br />
 * 
 ...
 * 		<li><strong> format : String</strong> - Controls whether the downloaded data is received as text (<code>"text"</code>), raw binary data (<code>"binary"</code>), or URL-stringifyd variables (<code>"variables"</code>). </li>
