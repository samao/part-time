package com.idzeir.buissnes
{
	...
	public class Enum
	{
		 ...
		 * 网址
		 */
		public static const WEB_URL:String = "http://www.wohai.com/";
		 ...
		 * 返回 全部房间信息
		 */
		public static const GET_ALL_ANCHOR:String = WEB_URL + "live/live!allanchor.action";
		/**
		 * rtmp流数据
		 * post 请求 传入用户id
		 * 返回流地址和流名称
		 */
		public static const GET_STREAM_ADDRESS:String = WEB_URL + "live/video!streamadr.action";
		/**
		 * 获取 用户id
		 * post请求 传入数据roomid
		 * 返回用户id
		 */
		public static const GET_ANCHOR_BY_ROOM_ID:String = WEB_URL + "live/live!getanchorbyroomid.action";
		
		/**
		 * 提交随机key让服务器生成游客用户 
		 * visitorsessionid=1400000000&roomid=10356
		 */		
		public static const SET_GUEST_KEY:String = WEB_URL + "chat/chat!visitorjoinbypoll.action";
		
		/**
		 * 用随机key查询用户信息
		 * visitorsessionid=1400000000
		 */		
		public static const GET_GUEST_INFO:String = WEB_URL + "chat/chat!getvisitorname.action";
		/**
		 * 轮询聊天内容
		 * datenocache[随机数]&username=yk_010286
		 */		
		public static const GET_CHAT_MSG:String = WEB_URL + "chat/chat!getmsgbypoll.action";
		/**
		 * 心跳 
		 * ?datenocache621&visitorsessionid = 1；
		 */		
		public static const SEND_HEART:String = WEB_URL + "chat/chat!heartbeat.action";
		
		/**
		 * 游客加入聊天
		 * visitorsessionid="+visitorsessionid+'&roomid="
		 */		
		public static const GUEST_JOIN_IN:String = WEB_URL + "chat/chat!visitorjoinbypoll.action";
